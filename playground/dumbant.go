...
func NewAnt(posX int32, posY int32) *Ant {
	...
	if posX != 100 {
		return &Ant{posX: posX, posY: posY, currDir: DOWN, state: RETURNER, path: lls.New()}
	}
	return &Ant{posX: posX, posY: posY, currDir: RIGHT, state: SEEKER, path: lls.New()}
}
...
func (a *Ant) Update(pheromones []*entity.Pheromone) {
...
func (a *Ant) IsPreviousPosition(posX int32, posY int32) bool {
	prevPosX := posX
	prevPosY := posY
	switch a.currDir {
	case UP:
